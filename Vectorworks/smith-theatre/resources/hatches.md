# Hatches / Tile Fills — Smith Theatre

> Standardized hatches and tile fills captured with the package (D-017).
...
- [ ] List the standardized hatches/fills for Smith (name + what it indicates).
- [ ] Decide if a `hatches.csv` manifest is warranted.
