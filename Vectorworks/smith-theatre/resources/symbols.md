# Symbols — Library Organization + Naming — Smith Theatre
...
## Proposed Smith category structure (DRAFT)

Aligned to the departments and object classes in play:

```
Lighting/        — instruments, accessories (hybrid, auto-classed Lighting-Device)
Rigging/         — pipes, points, motors, hardware
Scenic/          — hard units, soft goods, deck
Audio/           — speakers, mics, hardware
Video/           — projectors, cameras, screens
...
- [ ] Confirm the symbol library category structure above against the Smith inventory.
