...
- **`preview.html`** — the **theme × object gallery**: renders all 20 canonical objects from the active theme with a live token-coverage readout. Its menu auto-populates from `_index.json`. Pick a slug to reskin every object at once; this is the reskin/compare tool AND the coverage proof.
...
shared/themes/
  ...
  preview.html         theme × object gallery (menu auto-populates from _index.json)
