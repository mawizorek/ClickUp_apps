...
var FORMS={
"sharp":{"radius":"4px","radius-lg":"6px","radius-pill":"6px","border-w":"1.5px","grad-angle":"120deg","shadow-out":"0 1px 2px rgba(0,0,0,0.55), 0 2px 6px rgba(0,0,0,0.35)","shadow-in":"inset 0 2px 4px rgba(0,0,0,0.5)","elev-1":"0 1px 3px rgba(0,0,0,0.42)","elev-2":"0 5px 14px rgba(0,0,0,0.46)","elev-3":"0 14px 32px rgba(0,0,0,0.52)","motion-fast":"120ms","motion-med":"200ms","ease":"cubic-bezier(.2,.7,.2,1)","lift":"-2px"},
"soft":{"radius":"8px","radius-lg":"12px","radius-pill":"8px","border-w":"1px","grad-angle":"135deg","shadow-out":"0 2px 8px rgba(0,0,0,0.22), 0 8px 20px rgba(0,0,0,0.14)","shadow-in":"inset 0 1px 4px rgba(0,0,0,0.24)","elev-1":"0 2px 8px rgba(0,0,0,0.26)","elev-2":"0 9px 24px rgba(0,0,0,0.30)","elev-3":"0 22px 50px rgba(0,0,0,0.38)","motion-fast":"150ms","motion-med":"260ms","ease":"cubic-bezier(.16,1,.3,1)","lift":"-3px"},
"grounded":{"radius":"12px","radius-lg":"18px","radius-pill":"10px","border-w":"1px","grad-angle":"150deg","shadow-out":"0 1px 3px rgba(0,0,0,0.3), 0 4px 12px rgba(0,0,0,0.18)","shadow-in":"inset 0 1px 3px rgba(0,0,0,0.28)","elev-1":"0 3px 12px rgba(0,0,0,0.30)","elev-2":"0 11px 28px rgba(0,0,0,0.34)","elev-3":"0 26px 58px rgba(0,0,0,0.42)","motion-fast":"130ms","motion-med":"240ms","ease":"cubic-bezier(.2,.8,.2,1)","lift":"-3px"}
};
var SPACES={
...
var REGISTRY={
  "groups": {
    "shells": { "name": "Shells & containers", "desc": "Structural surfaces. Depth from surface fill + border + a tiered elevation shadow; each forms preset sets its own elev scale.", "objects": [
      ...
      { "id":"cnt_section_card", "name":"Section card", "rowLayout":false, "states":{ "base":{ "html":"<div class=\"tcard\"><h3>Section card</h3><p>A grouping card holds a related set of fields or content.</p></div>", "props":{ "Fill":"surface-2", "Line":"border", "Top rail":"accent-2", "Elevation":"elev-1", "Hover":"elev-2 + lift", "Corner":"radius-lg" } } } },
      ...
      { "id":"card_modal_standard", "name":"Modal", "rowLayout":false, "states":{ "base":{ "html":"<div class=\"tmodal\"><h3>Confirm action</h3><p>Highest elevation surface.</p><button class=\"tb primary\">Confirm</button></div>", "props":{ "Fill":"surface-3", "Line":"border", "Top rail":"accent-2", "Elevation":"elev-3", "Corner":"radius-lg" } } } }
    ] },
    ...
    "type": { "name": "Typography", "desc": "Display + body faces from Typography; ink colors from Color. Page titles carry an accent-grad leading tick.", "objects": [
      { "id":"tx_page_title", "name":"Page title", "rowLayout":false, "states":{ "base":{ "html":"<div class=\"ttype\"><div class=\"t1\">Loan application #4021</div></div>", "props":{ "Face":"font-display", "Ink":"text", "Tick":"accent-grad", "Size":"fs-lead" } } } },
    ...
    "buttons": { "name": "Buttons — full family", "desc": "Primary is a SOLID accent fill; secondary is a highlight-pink (accent-2) outline. Both lift on hover and bump one elevation step.", "objects": [
      { "id":"btn_family", "name":"Primary / secondary / quiet / destructive / icon", "rowLayout":true, "states":{ "normal":{ "html":"<button class=\"tb primary\">Primary</button> <button class=\"tb secondary\">Secondary</button> <button class=\"tb ghost\">Quiet</button> <button class=\"tb destructive\">Delete</button> <button class=\"tb icon\">⚙</button>", "props":{ "Primary":"accent", "On text":"on-accent", "Secondary":"accent-2", "Destructive":"bad", "Hover":"elev-2 + lift", "Corner":"radius" } }, "pressed":{ "html":"<button class=\"tb pressed\">Primary</button> <button class=\"tb secondary\" style=\"background:var(--surface-3);box-shadow:var(--shadow-in)\">Secondary</button> <button class=\"tb ghost\">Quiet</button>", "props":{ "Fill":"accent", "Shadow":"shadow-in", "Transform":"translateY(1px)" } } } }
    ] },
    ...
    "data": { "name": "Rows, tiles & badges", "desc": "Portal rows (hover highlight + selected accent-2 rail), metric tiles (accent-2 top rail, lift on hover), status badges.", "objects": [
      { "id":"row_tile_badge", "name":"Portal rows / metric tiles / status badges", "rowLayout":false, "states":{ "rows":{ "html":"<table class=\"ttable\"><thead><tr><th>Pos</th><th>Driver</th><th class=\"n\">Pts</th></tr></thead><tbody><tr><td>1</td><td>Norris</td><td class=\"n\">287</td></tr><tr class=\"alt\"><td>2</td><td>Piastri</td><td class=\"n\">265</td></tr><tr class=\"sel\"><td>3</td><td>Verstappen</td><td class=\"n\">241</td></tr></tbody></table>", "props":{ "Header":"text-soft", "Alternate":"surface-2", "Selected":"accent-soft", "Selected rail":"accent-2" } }, "tiles":{ "html":"<div style=\"display:flex;gap:12px;flex-wrap:wrap;width:100%\"><div class=\"ttile\"><div class=\"big\">8,412</div><div class=\"lab\">Active this week</div></div><div class=\"ttile\"><div class=\"big\" style=\"color:var(--bad)\">3 overdue</div><div class=\"lab\">Needs attention</div></div></div>", "props":{ "Fill":"surface-2", "Top rail":"accent-2", "Elevation":"elev-1", "Alert":"bad" } }, "badges":{ "html":"<div><span class=\"tpill neutral\">Draft</span> <span class=\"tpill good\">Active</span> <span class=\"tpill warn\">Pending</span> <span class=\"tpill bad\">Overdue</span></div>", "props":{ "Neutral":"surface-3", "Good":"good", "Warn":"warn", "Alert":"bad" } } } }
    ] }
  }
};
