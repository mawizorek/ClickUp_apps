...
// forward through the bracket (one-tap, first-class). No more \u24d8 badge.
...
function bmTeam(m, side) {
 ...
 // Right-side \u2192 = one-tap path trace forward through the bracket.
 const trace = traceable ? `<button class="bm-trace" data-team="${sl.text}" aria-label="Trace ${sl.text}'s path forward">\u2192</button>` : '';
