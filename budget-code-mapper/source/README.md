...
- `budget-code-mapper_partNN_of_NN.txt` — the ordered chunks (base64-encoded payloads, markers plain text)
- `README.md` — this file
...
> **Status:** awaiting fresh chunk set. Drag the File Chunker `source/` output here to populate.
