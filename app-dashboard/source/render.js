...
function render(apps){
 ...
 let tags = '';
 if(isRecent && !retired) tags += '<span class="tag tag-recent">Recent</span>';
 if(app.hasData) tags += '<span class="tag tag-data">Data</span>';
 if(retired) tags += '<span class="tag tag-retired">Retired</span>';
 ...
 let h = '<div class="row" data-category="'+cat+'" data-status="'+(app.status||'live')+'">';
