...
- **Treating "run it by the team" as a fixed checklist (the Wes ghost).** There is no static seven-lens "Wes process" to run. A whole-team review is Mira's LIVE seating call — who's weighing in now, weighted for the phase. Reciting a fixed roster instead of reading the moment is the retired pattern.
