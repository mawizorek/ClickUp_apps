...
**Current state (2026-07-15):** planning complete, zero tables written on purpose. All decisions locked incl. HML naming (DD-008). Layout-first articulation has begun (first render: `GLOBAL_Settings`). Prior-art / migration source = the **Budgeting | Shopping** space (not BETA BUDGET).
